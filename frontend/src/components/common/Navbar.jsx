...
// import eduGenicLogo from '../../assets/Logo/Logo-Full-Light.png'
...
//                 {/* logo */}
//                 <Link to="/">
//                     <img src={eduGenicLogo} width={160} height={42} loading='lazy' />
//                 </Link>
...
//                 {/* Logo */}
//                 <Link to="/">
//                     <img src={eduGenicLogo} width={160} height={42} loading='lazy' alt="EduGenic Logo" />
//                 </Link>
...
//                 {/* Login/SignUp/Dashboard */}
//                 <div className='flex gap-x-4 items-center'>
//                     {/* Shopping Cart - Not visible to Instructors and Admins */}
...
//                     {/* Login/Signup buttons - Only visible when not logged in */}
//                     {token === null && (
//                         <>
//                             <Link to="/login">
//                                 <button className={`px-[12px] py-[8px] text-richblack-100 rounded-md 
    ...
    return (
        <nav className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar} `}>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                {/* Logo */}
                <Link to="/">
                    <img src={studyNotionLogo} width={160} height={42} loading='lazy' alt="StudyNotion Logo" />
                </Link>
